...
export const ECOLOGICAL_DIMENSIONS: EcologicalDimension[] = [
  ...
  },
  {
    ...
    subIndicators: [
      ...
      { rawKey: "eco_naer_landbrug_raw", ratioKey: "eco_naer_landbrug_ratio", label: "N-loft landbrug (VP3)",          unit: "kg N/ha",           boundary: "Lavere N-loft pr. ha = mere presset end landsgennemsnit", lowerIsBetter: false, baselineType: "relativ" },
