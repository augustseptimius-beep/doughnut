...
export const ECOLOGICAL_DIMENSIONS: EcologicalDimension[] = [
  ...
  },
  {
    ...
    name: "Vand",
    shortName: "VAND",
    description: "Nitratindhold i drikkevand som indikator for grundvandskvalitet. Nitrat (NO₃⁻) er ikke en novel entity men et naturligt stof der ophober sig i grundvandsmagasiner ved overdreven kvælstofbelastning fra landbrug. Måles som kommunalt vægtet gennemsnit i mg/L.",
    source: "https://www.greenpeace.org/static/planet4-denmark-stateless/2025/11/d33ba39e-nitrat-i-danmarks-drikkevand.pdf",
    sourceLabel: "Greenpeace/GEUS Jupiter 2025",
    unit: "mg/L (kommunalt gennemsnit)",
    boundary: "6 mg/L (ekspertgruppens anbefaling 2025, baseret på tarmkræftrisiko)",
    subIndicators: [
