    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="text-sm text-gray-700 leading-relaxed mt-2">
            <strong>Økologiske dimensioner:</strong> Tallet viser hvor tæt kommunen er på grænseværdien. Nogle grænser er absolutte (WHO, EU-mål, 2,5 ton CO₂e pr. person, kystvandenes målbelastning for kvælstof), andre er landsgennemsnittet, hvor der ikke findes en meningsfuld grænse pr. kommune. En værdi under 100 er under grænsen, over 100 betyder overshoot.
          </p>
