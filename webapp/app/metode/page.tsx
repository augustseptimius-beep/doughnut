...
const SOCIAL_METHODS: Record<string, MethodInfo> = {
  ...
  lokalsamfund: {
    id: "lokalsamfund",
    scoring: "Gennemsnit af to indikatorer: (1) Biblioteksudlån pr. indbygger (BIB1) - direkte ratio til landsgennemsnit. (2) Idrætsfaciliteter pr. 10.000 indbyggere (IDRFAC01) - direkte ratio til landsgennemsnit. Score 100 = landsgennemsnit.",
    boundary: "Socialt fundament: levende lokalsamfund med kulturtilbud og faciliteter.",
    dataYear: "2023-2024",
    limitations: "Biblioteksudlån og idrætsfaciliteter er proxyer for kulturliv og serviceadgang. Dækker ikke andre vigtige services som læger, skoler og indkøb.",
    csvFile: "lokalsamfund_scores.csv",
  },
  mobilitet: {
    id: "mobilitet",
