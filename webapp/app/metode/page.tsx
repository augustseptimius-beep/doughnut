...
const ECO_METHODS: Record<string, MethodInfo> = {
  ...
  vand: {
    id: "vand",
    scoring: "Enkelt indikator: al vandindvinding i kommunen - almene vandværker, virksomheder med egen indvinding og markvanding, grundvand og overfladevand (DST VANDIND) - i mm pr. år over kommunens landareal, som gennemsnit af de tre seneste år. Ratio = (kommunens mm/år / Danmark samlet) × 100. Over 100 = mere pres på grundvandet pr. areal end landsgennemsnittet.",
    boundary: "Danmark samlet ({ref:vandindvinding:1} mm/år, {aar:vandindvinding}) som reference. Den faglige grænse er GEUS' opgørelse af den bæredygtige grundvandsressource (Henriksen m.fl. 2023), som CONCITO (2025) bruger som Danmarks sikre råderum for vand: ca. 1,1 mia. m³ om året for hele landet, hvoraf ca. 66% udnyttes, med størst overudnyttelse omkring København og Aarhus og i dele af Vestjylland. Opgørelsen pr. delopland findes kun som kort og er ifølge Miljøstyrelsen ikke autoritativ på den skala, så den kan ikke bruges pr. kommune endnu.",
    boundarySources: [
      { label: "GEUS (2023), Vandressourceopgørelse - datarapport (Henriksen m.fl.)", url: "https://data.geus.dk/pure-pdf/GEUS-R_2023_08_web.pdf" },
    ...
    limitations: "Indvindingen registreres hvor vandet pumpes op. Det er det rigtige sted at måle presset på grundvandet, men det betyder at en bykommune, der får sit vand fra kildepladser i nabokommunerne, står lavt, mens kommunerne med kildepladserne står højt. Grundvandsdannelsen er ikke ens i hele landet (lavere på lerjord, fx på Sjælland og Lolland-Falster), så samme indvinding pr. areal er et større pres dér - det fanges ikke. Små bykommuner med egne vandværker (fx Frederiksberg) får meget høje tal, fordi grundvandsoplandet er større end kommunen. Markvandingen svinger med sommerens nedbør; treårsgennemsnittet udjævner det. Indtil september 2026 målte indikatoren kun almene vandværker pr. indbygger, hvilket i praksis viste hvor HOFOR har kildepladser (Furesø, Ishøj og Lejre højest, København filtreret fra), og industri og markvanding (over halvdelen af indvindingen) indgik ikke.",
  },
  arealanvendelse: {
    id: "arealanvendelse",
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <section className="mb-10 p-5 bg-amber-50 border border-amber-200 rounded-xl">
        ...
        <p className="text-sm text-gray-700 leading-relaxed mt-4">
          ...
          Det betyder at kategorier med få indikatorer (f.eks. Bolig og Mobilitet med 2) vægter lige så tungt som kategorier med mange (f.eks. Sundhed og Uddannelse med 9).
